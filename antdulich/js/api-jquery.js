...
Bizweb.onCartShippingRatesUpdate = function(e, t) {
    ...
    r += t.country,
    alert("There are " + e.length + " shipping rates available for " + r + ", starting at " + Bizweb.formatMoney(e[0].price) + ".")
}
,
...
jQuery.fn.jquery >= "1.4" ? Bizweb.param = jQuery.param : (Bizweb.param = function(e) {
    var t = []
      , r = function(e, r) {
        ...
        t[t.length] = encodeURIComponent(e) + "=" + encodeURIComponent(r)
    };
